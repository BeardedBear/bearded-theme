module.exports.body = function(theme) {
    ...
    let merge = {
        ...
        "merge.currentContentBackground": theme.green + "30",
        "merge.currentHeaderBackground": theme.green + "80",
        "merge.incomingContentBackground": theme.blue + "30",
        "merge.incomingHeaderBackground": theme.blue + "80",
    ...
    let tabs = {
        ...
        "tab.inactiveForeground": theme.default + "70",
    ...
    return Object.assign(activityBar, badge, breadcrumb, button, common, debug, description, diff, dropdown, editor, editorMarker, editorOverviewRuler, find, gitlens, gutter, input, list, menu, merge, notification, panel, pickView, picker, progressbar, scrollbar, settings, sidebar, statusBar, suggest, tabs, terminal, text, titleBar, welcomePage);
};
