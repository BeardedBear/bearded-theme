...
function buildZedThemeStyle(
  ...
  return {
    ...
    hidden: alpha(ui.defaultalt, 0.5),
    hint: levels.info,
    "hint.background": alpha(levels.info, 0.1),
    ignored: alpha(ui.defaultalt, 0.4),
    ...
    "text.disabled": alpha(ui.defaultalt, 0.5),
    "text.muted": ui.defaultalt,
    "text.placeholder": alpha(ui.defaultalt, 0.6),
    // Title bar
