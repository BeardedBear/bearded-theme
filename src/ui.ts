...
export default function ui(theme: Theme): unknown {
  return {
    ...
    "diffEditor.removedTextBackground": `${theme.levels.danger}20`,
    "diffEditor.diagonalFill": theme.ui.primaryalt,
    // dropdown
    ...
    // list
    "list.activeSelectionBackground": `${theme.ui.primary}45`,
    ...
    "list.inactiveSelectionBackground": `${theme.ui.primary}45`,
