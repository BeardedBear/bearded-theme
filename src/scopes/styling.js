export const units = ["keyword.other.unit"];
export const pseudoClasses = ["entity.other.attribute-name.pseudo-class"];
export const pseudoElements = ["entity.other.attribute-name.pseudo-element"];
...
export const and = ["entity.name.tag.reference", "meta.property-list"];
